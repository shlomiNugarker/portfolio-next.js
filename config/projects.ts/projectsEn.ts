const projects = [
  ...
  },
  {
    ...
    videoUrl: '',
    description:
      'A modern, lightweight Tetris game built with TypeScript and the Canvas API. The game features smooth animations, dynamic difficulty adjustment, and a clean UI.',
  ...
  },
  {
    ...
    videoUrl: '',
    description:
      'A feature-rich Sudoku game built with TypeScript and optimized for fast, seamless gameplay in the browser. The game includes real-time move validation, dynamically generated Sudoku puzzles, difficulty level selection, and a sleek modern UI. Implemented using Object-Oriented Programming principles, it ensures a scalable and efficient architecture. Additionally, the game saves progress automatically via Local Storage, allowing players to resume from where they left off.',
    features: [
      '🎮 Fully interactive and dynamic Sudoku gameplay',
      '🔢 Intelligent Sudoku board generation with adjustable difficulty',
      ...
      '🖥️ Responsive design with adaptive grid layout',
  ...
  },
  {
    ...
    videoUrl: '',
    description:
      'A fast-paced 2D action game built using TypeScript, designed to run directly in the browser. The game features a player-controlled character that can move, jump, and attack enemies. With advanced physics-based interactions, collision animations, and layered background effects, this project showcases cutting-edge game development techniques using modern JavaScript and OOP principles.',
    features: [
      '🎮 Dynamic 2D action gameplay with full player control',
      '🕹️ Keyboard-controlled player movement with real-time physics',
      '👾 Advanced AI system for enemies with different attack patterns',
  ...
  },
  {
    ...
    videoUrl: '',
    description:
      'A modernized version of the classic Minesweeper game, built using JavaScript, HTML, and CSS. The game features dynamic board generation, intelligent cell reveal mechanics, mine flagging, win/loss conditions, and interactive sound effects for an enhanced gaming experience.',
    features: [
      '🎮 Classic Minesweeper gameplay with a modern design',
      '🛠️ Customizable board size and difficulty levels',
      '🔍 Smart cell reveal for empty areas',
  ...
  },
  {
    ...
    videoUrl: '',
    description:
      'Remote Sessions is a web-based platform enabling real-time code collaboration and remote programming sessions. The application allows multiple users to edit code simultaneously, with live updates via WebSockets. Built with React and TypeScript on the frontend, and Node.js with Express and MongoDB on the backend, it provides a seamless experience for developers working together.',
    features: [
      ...
      '🔄 Seamless state management using custom hooks',
  ...
  },
  {
    ...
    videoUrl: '',
    description:
      'A modern digital adaptation of the classic Monopoly board game, built with Vue.js and Vite. The game features real-time multiplayer support using WebSockets, interactive modals, dynamic board management, and responsive UI elements. Players can buy properties, trade assets, and compete in a fully immersive digital Monopoly experience.',
    features: [
      '🎲 Fully interactive Monopoly board game',
      '🌐 Multiplayer support via WebSockets',
      '🛠️ Custom-built game board with dynamic tile management',
      '💳 Property cards and player transactions',
      '📊 State management with Vuex for seamless gameplay',
  ...
  },
  {
    ...
    videoUrl: '',
    description:
      'The Ultimate Meme Generator is a web-based application that allows users to create and customize memes effortlessly. Users can select an image from the gallery, add multiple text layers, adjust text styles, and download their memes as images. The app also supports Local Storage for saving and reloading meme projects.',
    features: [
      '🖼️ Select an image from a rich meme gallery',
      '✏️ Add multiple text layers with customizable fonts and colors',
      '📏 Adjust text size, position, and alignment',
      '💾 Save created memes in Local Storage',
      '📥 Download memes as image files',
      '🎨 Intuitive and responsive UI',
      '⚡ Optimized rendering with HTML Canvas API',
    ],
    linkDemo:
